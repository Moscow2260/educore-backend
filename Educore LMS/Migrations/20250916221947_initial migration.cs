...
namespace Educore_LMS.Migrations
{
    /// <inheritdoc />
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTasks", x => new { x.StudentId, x.ModuleTaskId });
                    table.ForeignKey(
                        name: "FK_StudentTasks_ModuleTasks_ModuleTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTasks_ModuleTaskId",
                table: "StudentTasks",
                column: "ModuleTaskId");
        }
